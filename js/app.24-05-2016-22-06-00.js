...
//						syncObject[day].lessons[lesson].notes=notes
...
//						});
					...
					$scope.setDataOld = function(day, lesson, date, notes) {
						// $log.log("day: "+day+" lesson:"+lesson+" Date:
						// "+date+" Notes: "+notes);
						var noteRef = ref.child(day + "/lessons/" + lesson
								+ "/notes/");
						noteRef.set(notes);
						var dueRef = ref.child(day + "/lessons/" + lesson
								+ "/homeworkdue/");
						dueRef.set(date);
						// $cookies.setObject();
					};
